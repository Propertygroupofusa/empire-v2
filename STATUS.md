...
_Generated automatically at 2026-09-19 16:55:16 UTC. Read-only real account data - this file is written by the running app on a timer and pushed to the `status-snapshots` branch (never `main`). Numbers reflect the live database and, where noted, live Coinbase/Alpaca prices at generation time._
...
|---|---|---|---|---|---|---|---|---|
| crypto_grid_2 | STX-USD | $442.83 | 2.50% | 3 | 0 | $0.31 | 🛑 $612.83 (28% down) |  |
| crypto_grid_3 | ETH-USD | $342.82 | 2.50% | 3 | 0 | $2,646.56 | 🛑 $637.82 (46% down) |  |
| crypto_grid_4 | ARB-USD | $488.52 | 2.50% | 3 | 3 | $0.21 | $637.21 (0% down) |  |
...
|---|---|---|---|---|---|
| USO | long | 1.0 | $154.00 | $153.82 | -$0.18 |

## 📡 Recent Activity (most recent first)

| When (UTC) | Branch | Type | What happened |
|---|---|---|---|
| 2026-09-18 12:28:48 | crypto_grid_3 | REALLOCATE | Moved $20.00 of its own idle real cash into grid branch crypto_grid_4 (ARB-USD) |
| 2026-09-18 12:28:47 | crypto_grid_4 | BUY | Received $20.00 moved from grid branch crypto_grid_3 - branch total now $488.52 |
| 2026-09-18 01:04:39 | dashboard | MANUAL_OVERRIDE | Manually excluded UNI-USD from the live watchlist |
