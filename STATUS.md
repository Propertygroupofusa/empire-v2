...
_Generated automatically at 2026-09-16 02:10:04 UTC. Read-only real account data - this file is written by the running app on a timer and pushed to the `status-snapshots` branch (never `main`). Numbers reflect the live database and, where noted, live Coinbase/Alpaca prices at generation time._
...
|---|---|---|---|---|---|---|---|---|
| crypto_grid_2 | STX-USD | $612.83 | 2.50% | 3 | 0 | $0.24 | $612.83 (0% down) |  |
| crypto_grid_3 | ETH-USD | $637.82 | 2.50% | 3 | 0 | $2,391.51 | $637.82 (0% down) |  |
| crypto_grid_4 | ARB-USD | $468.52 | 2.50% | 3 | 3 | $0.15 | $472.35 (6% down) | 🔒 |
